      ...
      <div className='flex justify-center'>
        <div className='w-10/12 my-6 bg-custom'>
          ...
          <div className='text-center'>
            <a className='btn border-sky-400 my-6 bg-transparent hover:bg-sky-400' href="#my-modal-2">
              Result
            </a>
            ...
            <div className='modal' id='my-modal-2'>
              <div className='modal-box w-11/12 max-w-5xl'>
                ...
                <p className='text-md'>{mystate.length<=5 ? `Your ${name} Mark  is ${mystate.length} Your have to practice more`:`Your Mark ${name} is ${mystate.length} `}</p>
                <div className='modal-action'>
                <a  href="#" className='btn border-red-400 bg-transparent hover:bg-red-400  text-black' onClick={handleReset}>
              Restart
            </a>  
                </div>
              </div>
